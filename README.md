...
This repo contains the code for ResourceCreator, a Bad Echo `dotnet` tool. ResourceCreator is used to generate resource files for assets that Visual Studio's managed resources editor has trouble handling.
